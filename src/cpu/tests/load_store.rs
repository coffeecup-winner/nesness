...
fn test_ldx() {
    ...
    cpu.reg_y = y;
    ram[zpg as usize] = v + 1;
    ram[(zpg + y) as usize] = v + 2;
    ram[abs as usize] = v + 3;
    ram[(abs + y as u16) as usize] = v + 4;
    ram[(abs2 + y as u16) as usize] = v + 5;
...
fn test_ldy() {
    ...
    ram[abs as usize] = v + 3;
    ram[(abs + x as u16) as usize] = v + 4;
    ram[(abs2 + x as u16) as usize] = v + 5;
...
fn test_sta() {
    ...
    assert_eq!(v + 4, ram[(abs + y as u16) as usize]);
    assert_eq!(v + 5, ram[inx as usize]);
    assert_eq!(v + 6, ram[(iny + y as u16) as usize]);
}
...
fn test_stx() {
    ...
    assert_eq!(v + 0, ram[zpg as usize]);
    assert_eq!(v + 1, ram[(zpg + y) as usize]);
    assert_eq!(v + 2, ram[abs as usize]);
}
